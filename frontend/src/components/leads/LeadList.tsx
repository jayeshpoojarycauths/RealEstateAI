...
const LeadList: React.FC = () => {
    ...
    const handleSubmit = async (values: any) => {
        try {
            ...
            message.success(`Lead ${editingLead ? 'updated' : 'created'} successfully`);
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (status: LeadStatus) => (
                <Tag color={
                    status === LeadStatus.NEW ? 'blue' :
                    status === LeadStatus.CONTACTED ? 'orange' :
                    status === LeadStatus.QUALIFIED ? 'green' :
                    status === LeadStatus.CONVERTED ? 'purple' :
                    'red'
                }>
                    {status}
                </Tag>
        ...
        },
        {
            ...
            render: (source: LeadSource) => (
                <Tag color={
                    source === LeadSource.WEBSITE ? 'blue' :
                    source === LeadSource.REFERRAL ? 'green' :
                    source === LeadSource.SOCIAL_MEDIA ? 'purple' :
                    'orange'
                }>
                    {source}
                </Tag>
